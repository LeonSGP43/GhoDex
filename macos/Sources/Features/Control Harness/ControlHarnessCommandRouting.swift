...
enum ControlHarnessCommandAliases {
    ...
    static let namespaceAliases: [String: String] = [
        ...
        "diagnostics.logs.query": "diagnostics.logs.query",
        ...
        "diagnostics.crash.latest": "diagnostics.crash.latest",
        "diagnostics.mode.get": "diagnostics.mode.get",
        "diagnostics.mode.set": "diagnostics.mode.set",
        "diagnostics.retention.get": "diagnostics.retention.get",
        "diagnostics.retention.apply": "diagnostics.retention.apply",
        "diagnostics.cleanup.run": "diagnostics.cleanup.run",
        "diagnostics.export.bundle": "diagnostics.export.bundle",
    ]
