...
enum AppLocalization {
    ...
    private static let englishTable: [String: String] = [
        ...
        "settings.body": "Language can be configured here. For advanced terminal settings, edit $HOME/.config/ghostty/config.ghostty and restart GhoDex.",
    ...
    private static let simplifiedChineseTable: [String: String] = [
        ...
        "about.github": "GitHub",
        "settings.title": "设置",
        "settings.body": "这里目前可配置应用语言。若要修改高级终端配置，请编辑 $HOME/.config/ghostty/config.ghostty，然后重启 GhoDex。",
