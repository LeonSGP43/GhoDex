...
pub fn run(gpa_alloc: std.mem.Allocator) !u8 {
    ...
    if (resources_dir == null)
        try stderr.print("Could not find the GhoDex resources directory. Please ensure " ++
            "that GhoDex is installed correctly.\n", .{});
...
const Preview = struct {
    ...
    pub fn run(self: *Preview) !void {
        ...
        try self.vx.setTitle(writer, "👻 GhoDex Theme Preview 👻");
        ...
        switch (self.mode) {
            ...
            .save => {
                ...
                const save_instructions = [_][]const u8{
                    "To apply this theme, add the following line to your GhoDex configuration:",
                    "",
