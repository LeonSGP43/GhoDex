...
/// GhoDex. This uses the exact same font discovery mechanism GhoDex uses to
/// find fonts to use.
///
...
/// same priority order GhoDex would use to pick a font.
///
/// Flags:
///
...
///     is identical to the `font-family` set of GhoDex configuration values, so
