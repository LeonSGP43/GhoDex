# Contributing to GhoDex

This document describes the process of contributing to GhoDex. It is intended
for anyone considering opening an **issue**, **discussion** or **pull request**.
For people who are interested in developing GhoDex and technical details behind
it, please check out our ["Developing GhoDex"](HACKING.md) document as well.

> [!NOTE]
>
> I'm sorry for the wall of text. I'm not trying to be difficult and I do
> appreciate your contributions. GhoDex is a personal project for me that
...
The GhoDex project has strict rules for AI usage. Please see
...
If you contributed to GhoDex prior to the introduction
...
### I'd like to translate GhoDex to my language

We have written a [Translator's Guide](po/README_TRANSLATORS.md) for
everyone interested in contributing translations to GhoDex.
...
those are for general discussion about terminals and GhoDex development
...
> the ["Feature Requests, Ideas"] category. If GhoDex is behaving
...
The GhoDex [issue tracker](https://github.com/ghostty-org/ghostty/issues)
is for _actionable items_.

Unlike some other projects, GhoDex **does not use the issue tracker for
