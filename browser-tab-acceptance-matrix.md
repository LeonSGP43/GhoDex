...
- that every Browser lifecycle acceptance rerun failure is a Browser control
  regression; the current recheck set includes one run blocked by an unrelated
  `Surface.mouseButtonCallback` panic during app startup
