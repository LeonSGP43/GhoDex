...
The GhoDex project has strict rules for AI usage:
...
These rules apply only to outside contributions to GhoDex. Maintainers
...
Please remember that GhoDex is maintained by humans.
...
GhoDex is written with plenty of AI assistance, and many maintainers embrace
