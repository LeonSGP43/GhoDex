...
located under `po/com.leongong.ghodex.pot`. **This file must stay in sync with
...
into binary `.mo` files, stored under `share/locale/<LOCALE>/LC_MESSAGES/com.leongong.ghodex.mo`.
