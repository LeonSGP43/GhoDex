...
- Fast todo access still belongs to the app shell, so the quick entry point opens the existing Settings Panel instead of inventing a second editor window.
...
- The app-wide todo action opens the Settings Panel directly to the `Todo` tab.
